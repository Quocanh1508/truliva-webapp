...
export default function DateRangePicker({
  ...
  return (
    <div className={`relative ${className || 'inline-block'} text-left ${isOpen ? 'z-50' : 'z-10'}`} ref={containerRef}>
      ...
      {isOpen && (
        <div className={`absolute ${align === 'right' ? 'right-0' : 'left-0'} mt-2 bg-white border border-gray-200 rounded-xl shadow-2xl z-[999] flex flex-col md:flex-row overflow-hidden divide-y md:divide-y-0 md:divide-x divide-gray-150 animate-in fade-in slide-in-from-top-1 duration-150 max-w-[95vw]`}>
