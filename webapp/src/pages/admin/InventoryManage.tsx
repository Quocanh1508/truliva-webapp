...
export default function InventoryManage() {
  ...
  const filteredProducts = products.filter(p => {
    ...
    // 3. Lọc theo trạng thái Hết hàng (kho được chọn có tồn kho <= 0)
    ...
    // 4. Lọc theo trạng thái Còn hàng (kho được chọn có tồn kho > 0)
  ...
  const {
    ...
    dependencies: [warehouses.length, selectedWarehouses.length, filteredProducts.length],
  });
